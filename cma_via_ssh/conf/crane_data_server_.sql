...
CREATE TABLE `event` (
  ...
  `pid` tinyint unsigned NOT NULL COMMENT 'Идентификатор тэга.',
  ...
  PRIMARY KEY (`uid`),
  KEY `idx1` (`timestamp`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='События. Только тэги дискретных значений, регистрируется 0 - как норма, > 0 - как авария.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fault` (
  ...
  KEY `id_idx` (`pid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='Записи регистратора. Только тэги аналоговых значений, регистрируемые по изменению.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='Отчеты об ошибках в работе приложений.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='Константы, настройки и уставки для базы данных';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=726 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='Справочник тэгов проекта.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-11-15 13:45:54
